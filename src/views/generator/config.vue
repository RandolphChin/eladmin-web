        ...
        <el-card class="box-card" shadow="never">
          ...
          <el-form ref="form" :model="form" :rules="rules" size="small" label-width="78px">
            <el-form-item label="作者名称" prop="author">
              <el-input v-model="form.author" style="width: 40%" placeholder="姓名或昵称" />
              <span style="color: #C0C0C0;margin-left: 10px;">类上面的作者名称</span>
            </el-form-item>
            <el-form-item label="模块名称" prop="moduleName">
              <el-input v-model="form.moduleName" style="width: 40%" placeholder="lims-system" />
              <span style="color: #C0C0C0;margin-left: 10px;">模块的名称，请选择项目中已存在的模块，示例 lims-system</span>
            </el-form-item>
            <el-form-item label="至于包下" prop="pack">
              <el-input v-model="form.pack" style="width: 40%" placeholder="com.laboratory.modules.base.certificateManage" />
              <span style="color: #C0C0C0;margin-left: 10px;">项目包的名称，生成的代码放到哪个包里面com.laboratory.modules.base.certificateManage</span>
            </el-form-item>
            <el-form-item label="接口名称" prop="apiAlias">
              <el-input v-model="form.apiAlias" style="width: 40%" placeholder="人员资质" />
              <span style="color: #C0C0C0;margin-left: 10px;">接口的名称，用于控制器与接口文档中</span>
            </el-form-item>
            <el-form-item label="前端路径" prop="path">
              <el-input v-model="form.path" style="width: 40%" placeholder="绝对路径\lims8000-web\src\views\certificateManage\person" />
              <span style="color: #C0C0C0;margin-left: 10px;">输入views文件夹下的目录，不存在即创建，示例D:\projects\lims8000-web\src\views\certificateManage\person</span>
            </el-form-item>
            <el-form-item label="接口目录">
              <el-input v-model="form.apiPath" style="width: 40%" placeholder="绝对路径\lims8000-web\src\api\certificateManage\person" />
              <span style="color: #C0C0C0;margin-left: 10px;">Api存放路径[src/api]，为空则自动生成路径，示例D:\projects\lims8000-web\src\api\certificateManage\person</span>
            </el-form-item>
