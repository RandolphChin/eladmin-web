            ...
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" style="margin-top: 10px;" size="small" label-width="65px">
                <el-form-item label="邮箱" prop="email">
                  ...
                  <span style="color: #C0C0C0;margin-left: 10px;">邮箱地址</span>
                </el-form-item>
                <el-form-item label="手机号" prop="phone">
                  <el-input v-model="form.phone" style="width: 35%;" />
                  <span style="color: #C0C0C0;margin-left: 10px;">手机号码</span>
                </el-form-item>
...
export default {
  ...
  created() {
    this.form = { id: this.user.id, username: this.user.username, email: this.user.email, gender: this.user.gender, phone: this.user.phone }
