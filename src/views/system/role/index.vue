      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17" style="margin-bottom: 10px">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="table" v-loading="crud.loading" highlight-current-row style="width: 100%;" :data="crud.data" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
            ...
            <el-table-column v-if="checkPer([defaultAdminUser,'roles:edit','roles:del'])" label="操作" width="130px" align="center" fixed="right">
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="7">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            ...
            <el-button
              v-permission="[defaultAdminUser,'roles:edit']"
              :disabled="!showButton"
              :loading="menuLoading"
              icon="el-icon-check"
              size="mini"
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: [defaultAdminUser, 'roles:add'],
        edit: [defaultAdminUser, 'roles:edit'],
        del: [defaultAdminUser, 'roles:del']
      },
      rules: {
        name: [
