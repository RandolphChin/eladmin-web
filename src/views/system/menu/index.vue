<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="checkPer([defaultAdminUser,'menu:edit','menu:del'])" label="操作" width="130px" align="center" fixed="right">
        <template slot-scope="scope">
          <udOperation
            :data="scope.row"
...
export default {
  ...
  data() {
    return {
      menus: [],
      permission: {
        add: [defaultAdminUser, 'menu:add'],
        edit: [defaultAdminUser, 'menu:edit'],
        del: [defaultAdminUser, 'menu:del']
      },
      rules: {
        title: [
