<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="checkPer([defaultAdminUser,'dept:edit','dept:del'])" label="操作" width="130px" align="center" fixed="right">
        <template slot-scope="scope">
          <udOperation
            :data="scope.row"
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: [defaultAdminUser, 'dept:add'],
        edit: [defaultAdminUser, 'dept:edit'],
        del: [defaultAdminUser, 'dept:del']
      },
      enabledTypeOptions: [
